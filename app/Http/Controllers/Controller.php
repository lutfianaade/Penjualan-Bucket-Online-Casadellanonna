...
class Controller extends BaseController
{
    ...
    {
        // Temukan cart berdasarkan id dan kondisi idUser dan status
        $chart = tblCart::where(['id' => $id, 'idUser' => 'guest123', 'status' => 0])->first();

        // Jika cart tidak ditemukan, redirect dengan pesan error
        if(!$chart){
