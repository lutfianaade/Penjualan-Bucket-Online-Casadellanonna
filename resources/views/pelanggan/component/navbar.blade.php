<nav class="navbar navbar-dark navbar-expand-lg z-index" style="background-color: #E78895">
    <div class="container">
        <div class="d-flex gap-2 align-items-center">
            <a class="navbar-brand" href="#">Cassadelanonna Bouquet
        ...
        <div class="collapse navbar-collapse justify-content-end gap-4" id="navbarSupportedContent">
            <ul class="navbar-nav gap-4">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == 'shop' ? 'active' : '' }}" href="/shop">Product</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="text-links">
                            <div class="d-flex gap-2 align-items-center">
                                <img src="{{ asset('storage/user/' . Auth::user()->foto) }}" class="rounded-circle "
                                    style="width: 40px; height:40px; background-size: cover;" alt="">
