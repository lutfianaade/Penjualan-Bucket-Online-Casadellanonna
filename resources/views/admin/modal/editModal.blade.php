                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="Buket" {{ $data->type === 'buket' ? 'selected' : '' }}>Buket</option>
                                <option value="Hampers" {{ $data->type === 'hampers' ? 'selected' : '' }}>Hampers</option>
                                <option value="Cake" {{ $data->type === 'cake' ? 'selected' : '' }}>Cake
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Kecil" {{ $data->kategory === 'Kecil' ? 'selected' : '' }}>Kecil</option>
                                <option value="Sedang" {{ $data->kategory === 'Sedang' ? 'selected' : '' }}>Sedang
                                </option>
                                <option value="Besar" {{ $data->kategory === 'Besar' ? 'selected' : '' }}>
                                    Besar</option>
                            </select>
                        </div>
                    </div>
